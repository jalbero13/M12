      ...
      <table class="table tabla">
        ...
        @foreach($arrayAlumnes as $key => $alumno)
          <tr class="tabla-fila">
            ...
            <td>  
                <div class="btn-group">
                  <a href="/editAlumne/{{$alumno->id}}" type="button" class="btn btn-outline-secondary">
                  ...
                  <a href="{{route('eliminarAlumno', $alumno->id)}}" type="button" class="btn btn-outline-secondary">
