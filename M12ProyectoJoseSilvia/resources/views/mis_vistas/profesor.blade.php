            ...
            <tbody>
              ...
              <tr class="tabla-fila">
                ...
                <div class="btn-group">
                  ...
                  @if($profe->id !=1)
                  <a href="{{route('eliminarProfesor', $profe->id)}}" type="button" class="btn btn-outline-secondary">
                  ...
                  @endif
                  <a href="/inscriureProfessor/{{$profe->id}}" type="button" class="btn btn-outline-secondary">
                    ...
                    <span class="visually-hidden">Inscriure</span>
                  </a>
                </div>
              </td>
